    ...
    <div>
      ...
      <div className="space-y-5">
        ...
        <Card>
          ...
          <p className="mb-3 text-xs text-ink-3 dark:text-white/40">
            {t("settings.chatLanguageHint", "Choose how Reetu replies. This is independent from the interface language — for example, you can keep the app in English and chat in Hinglish.")}
          </p>
