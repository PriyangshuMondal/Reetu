...
function makeCorsOrigins(
  ...
  // Same-origin in production (the server serves client/dist).
  // In development allow any localhost origin since the Vite
  // dev server port can vary.
